...
import (
	...
	"github.com/svector-corporation/orbit-cli/internal/tui/components/chat"
	"github.com/svector-corporation/orbit-cli/internal/tui/components/core"
	"github.com/svector-corporation/orbit-cli/internal/tui/components/dialog"
	"github.com/svector-corporation/orbit-cli/internal/tui/layout"
	"github.com/svector-corporation/orbit-cli/internal/tui/page"
	"github.com/svector-corporation/orbit-cli/internal/tui/theme"
	"github.com/svector-corporation/orbit-cli/internal/tui/util"
)
...
func New(app *app.App) tea.Model {
	...
	model.RegisterCommand(dialog.Command{
		...
		Description: "Create/Update the Orbit.md memory file",
		Handler: func(cmd dialog.Command) tea.Cmd {
			prompt := `Please analyze this codebase and create a Orbit.md file containing:
1. Build/lint/test commands - especially for running a single test
2. Code style guidelines including imports, formatting, types, naming conventions, error handling, etc.

The file you create will be given to agentic coding agents (such as yourself) that operate in this repository. Make it about 20 lines long.
If there's already a orbit.md, improve it.
